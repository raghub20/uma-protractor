...
export class LevelService {
  ...
  levelList: Level[] = [
    { levelId: 'L1', levelName: 'Level 1 (Over 250,000 USD)', levelDescription: 'Level 1 - Salary Range' },
    { levelId: 'L2', levelName: 'Level 2 (100,001 to 250,000 USD)', levelDescription: 'Level 2 - Salary Range' },
    { levelId: 'L3', levelName: 'Level 3 (Up to 100,000 USD)', levelDescription: 'Level 3 - Salary Range' }
];
